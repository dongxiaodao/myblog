<%--
  Create by ghost 2018/3/19 10:12
--%>
...
<head>
    ...
    <link rel="shortcut icon" href="<%=path%>/static/admin/images/favicon.png"/>
    <link href="//cdn.bootcss.com/bootstrap/3.3.7/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
    <link href="<%=basePath%>/static/admin/css/style.min.css" rel="stylesheet" type="text/css">
